...
type ExportPartialSuccess struct {
	orig *otlpcollectordiscovery.ExportDiscoveryPartialSuccess
	state *internal.State
}

func newExportPartialSuccess(orig *otlpcollectordiscovery.ExportDiscoveryPartialSuccess, state *internal.State) ExportPartialSuccess {
...
func NewExportPartialSuccess() ExportPartialSuccess {
	...
	return newExportPartialSuccess(&otlpcollectordiscovery.ExportDiscoveryPartialSuccess{}, &state)
}
...
func (ms ExportPartialSuccess) MoveTo(dest ExportPartialSuccess) {
	...
	*dest.orig = *ms.orig
	*ms.orig = otlpcollectordiscovery.ExportDiscoveryPartialSuccess{}
}



// RejectedDiscoveryRecords returns the rejecteddiscoveryrecords associated with this ExportPartialSuccess.
func (ms ExportPartialSuccess) RejectedDiscoveryRecords() int64 {
	return ms.orig.RejectedDiscoveryRecords
}

// SetRejectedDiscoveryRecords replaces the rejecteddiscoveryrecords associated with this ExportPartialSuccess.
func (ms ExportPartialSuccess) SetRejectedDiscoveryRecords(v int64) {
	ms.state.AssertMutable()
	ms.orig.RejectedDiscoveryRecords = v
}
...
func (ms ExportPartialSuccess) CopyTo(dest ExportPartialSuccess) {
	dest.state.AssertMutable()
		dest.SetRejectedDiscoveryRecords(ms.RejectedDiscoveryRecords())
