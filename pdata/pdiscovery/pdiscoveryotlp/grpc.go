...
func NewGRPCClient(cc *grpc.ClientConn) GRPCClient {
	return &grpcClient{rawClient: otlpcollectordisc.NewLogsServiceClient(cc)}
}

type grpcClient struct {
	rawClient otlpcollectordisc.LogsServiceClient
}
...
func RegisterGRPCServer(s *grpc.Server, srv GRPCServer) {
	otlpcollectordisc.RegisterLogsServiceServer(s, &rawLogsServer{srv: srv})
}
...
func (s rawLogsServer) Export(ctx context.Context, request *otlpcollectordisc.ExportLogsServiceRequest) (*otlpcollectordisc.ExportLogsServiceResponse, error) {
