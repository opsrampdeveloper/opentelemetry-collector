...
type ExportResponse struct {
	orig  *otlpcollectordisc.ExportDiscoveryServiceResponse
...
func (ms ExportPartialSuccess) unmarshalJsoniter(iter *jsoniter.Iterator) {
	iter.ReadObjectCB(func(_ *jsoniter.Iterator, f string) bool {
		switch f {
		case "rejected_discovery_records", "rejectedDiscoveryRecords":
			ms.orig.RejectedDiscoveryRecords = json.ReadInt64(iter)
